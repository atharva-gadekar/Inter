    ...
    <>
      <div className="bg-white rounded-xl border shadow-slate-100 p-6 lg:flex items-center ml-[4.5rem] w-[53rem] hidden">
        <div className="relative w-full">
          <input type="text" onClick={showModal} className="w-full px-4 py-2 rounded-lg text-sm focus:outline-none border-gray-300 cursor-pointer" placeholder="Create a new post..." />
        </div>
      ...
      >
        ...
        <Select mode="tags" style={{ width: '100%' }} placeholder="Blog Tags" className="mb-4">
